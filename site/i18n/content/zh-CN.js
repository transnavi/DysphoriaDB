...
const experiences = {
  ...
  "self-hatred": localizedExperience(
    "对自己的厌恶",
    "厌恶可能落在自己整个人身上：外貌、在别人眼中的样子，以及自己认为自己是怎样的人。针对同类人的那些说法，也可能变成描述自己时的日常用词。",
    [
      ["侮辱的说法变成自称", "针对跨性别者的蔑称和嘲笑，可能变成描述自己的脸、身体或声音时的日常用词。"],
      ["比身边任何人都更严厉", "对自己下的判断，可能远重于身边的人所说的话或看起来所想的。"],
      ["站在别人身边时", "被人看见与伴侣或朋友同行，可能让自己对外貌的解读更加尖锐，两人在一起本身也可能像是把自己暴露出来。"],
      ["认识自己以前抱有的厌恶", "在意识到自己也是其中一员之前对跨性别者的厌恶，可能把那套用词留到之后。"],
    ],
  ),
  ...
  "discomfort-with-your-body-being-seen": localizedExperience(
    ...
    [
      ["公共浴室与更衣空间", "在公共浴池、温泉、公共淋浴间和更衣室，人们可能需要在他人面前脱衣或洗浴，这些场合会带来强烈负担。"],
      ["游泳池与海滩", "泳装会显露身体轮廓或性征，使人难以前往游泳池、海滩，参加游泳课或水上活动。"],
      ["健康检查与诊疗", "在健康检查或诊疗中需要换衣、露出身体部位或接受触诊时，焦虑或性别焦虑可能会加重。"],
  ...
  "hesitating-over-gender-fields": localizedExperience(
    ...
    [
      ["最先想到的答案", "看到性别栏时，一个人可能会下意识地想要填写或选择自己认同的性别。"],
      ["改填出生指派性别", "表格似乎要求法定信息或他人通常使用的答案时，一个人可能会长时间犹豫，随后改填出生指派性别。"],
      ["犹豫与不作答", "性别栏可能比表格的其他部分花费更多时间。一个人可能会留空、选择“不愿透露”，或在允许时回避作答。"],
      ["作答后的痛苦", "填写出生指派性别可能令人难过，日后再次看到已经记录的答案也会重新引起不适。"],
  ...
  "another-gender-in-games-and-imagined-roles": localizedExperience(
    ...
    [
      ...
      ["服装与Cosplay", "扮成另一性别的角色并以那副样子出现在人前，可能带来从未有过的愉悦，之后也可能一直做下去。"],
  ...
  "voice-feels-unlike-oneself": localizedExperience(
    "觉得自己的声音不像自己",
    "说话、听录音，或在青春期及睾酮治疗中经历声音变化时，如果音高、共鸣、说话方式或别人对声音的性别判断与自我感受冲突，可能产生强烈的不协调感。",
    [
      ["害怕即将发生的变声", "青春期临近或不想要的声音低沉开始出现时，人们可能因这种变化难以逆转而感到强烈恐惧、悲伤或绝望。"],
      ["处在变声过程中", "破音、音高与共鸣改变或控制力下降，会让说话和唱歌变得不稳定，也让声音显得陌生。"],
      ["回避使用声音", "听见自己的声音或被他人根据声音判断性别可能十分痛苦，使人回避交谈、通话、录音、公开发言或唱歌。"],
      ["担心期待的变化不会发生", "希望睾酮使声音降低时，人们可能强烈担忧变化太慢、幅度太小或完全不发生。"],
      ["担心失去熟悉的声音", "即使期待变声，也可能担心失去原有音域、歌唱能力、职业技能或已经熟悉的声音。"],
    ],
  ),
  ...
  "singled-out-around-gendered-privacy": localizedExperience(
    ...
    [
      ["以隐私为由单独排除", "其他朋友都可以留下时，只有本人在同性别卫生间、更衣区域、洗澡场所、卧室、睡觉位置安排或其他私人场合被要求离开或单独行动。"],
      ["身体接触受到区别对待", "朋友可能会拥抱其他同性别伙伴、挨着坐或有日常的身体接触，却因为仍按出生指派性别归类本人而单独避开这些接触。"],
      ["到家中做客与过夜", "对方可能避免去本人家中、邀请本人到家中、共用住宿空间或让本人参加过夜聚会，同时愿意与其他同性别伙伴这样相处。"],
      ["避免单独相处", "朋友可能愿意在群体中相处，却因为对性别、吸引或安全的假设，拒绝与本人单独见面、同行、学习或私下交谈。"],
      ["有条件的认可", "平时使用正确的姓名和代词，仍可能与隐私或亲近关系中的不平等规则同时出现，让人感到朋友依然把自己归入另一个性别类别。"],
      ["尊重同意与隐私", "每个人都可以决定由谁触碰自己、让谁进入私人空间、与谁单独相处。本人也可以充分尊重这些界限。当反复出现的不平等做法传达出出生指派性别仍决定他人如何看待本人时，痛苦可能随之产生。"],
      ["集体活动中的共同准备", "婚礼、演出、体育活动、旅行等集体场合可能包含共同换衣或准备。只排除跨性别参与者，会让本人失去群体成员之间通常具有的信任。"],
  ...
  "separate-online-identity-until-gender-disclosure-feels-safe": localizedExperience(
    ...
    [
      ...
      ["身份在非自愿情况下被关联", "被迫出柜，或账号意外关联到现实身份时，可能产生强烈的悲伤、恐惧、愤怒或不安。之后可能疏远朋友、弃用账号、删除内容或回避网络交流。"],
  ...
  "recurring-doubt-about-being-trans-enough": localizedExperience(
    "反复怀疑自己是否“足够跨性别”",
    "即使与性别有关的愿望、轻松感或痛苦一再出现，人们仍可能因为这些体验不够强烈、明确、出现得不够早，缺少身体上的性别焦虑，或不符合常见叙事，而反复怀疑自己是否有资格认同为跨性别或非二元性别。",
    [
      ["与他人的经历比较", "别人的笃定、性别焦虑、童年记忆或性别过渡目标，可能显得比自己的经历更有说服力。"],
      ["从小没有明确认知", "童年时没有意识到自己的性别，或后来才看懂早期经历的含义，都可能成为自我怀疑的原因。"],
      ["觉得性别焦虑太轻", "不适感较轻、时断时续、主要来自社交处境或难以描述时，与严重的身体性别焦虑相比可能显得不够充分。"],
      ["不符合常见叙事", "兴趣、外表、性取向、性别表达或非二元身份，可能与最先接触到的跨性别故事不同。"],
      ["害怕自己判断错误", "对后悔、性别过渡、人际关系、安全或外表的担忧，可能逐渐变成对自身身份真实性的反复怀疑。"],
      ["给探索留出空间", "自我怀疑无法决定一个人的性别。给自己时间、在低压力下尝试，并留意反复出现的体验，有助于看清什么更适合自己。"],
    ],
  ),
  ...
  "libido-or-arousal-feels-alien": localizedExperience(
    ...
    [
      ...
      ["禁欲与严苛自律", "本人可能严格限制性行为、约会、幻想和欲望表达，把禁欲、避免发生性关系或对情感与欲望的强力控制视为自己必须遵守的条件。"],
      ["对亲密关系的愿望仍然存在", "本人可能仍有性吸引，也真诚地渴望恋爱关系或亲密接触，同时不允许自己追求这些愿望。"],
      ["内疚与缺乏自信", "欲望本身可能引发内疚，让人觉得自己未能满足内心设定的条件，或觉得自己不适合恋爱、性行为和伴侣关系。"],
      ["欲望与身体反应分离", "吸引可能真实存在，兴奋、生殖器反应或附带的角色却显得陌生。"],
      ["变化带来放松", "性别过渡期间性欲或自发兴奋的变化，可能减轻反复出现的痛苦。"],
    ],
    [
      "勃起、与雄激素相联系的性欲，以及主动发起或插入的期待，可能让人感到自己被放进不想要的男性角色。",
      "润滑、生殖器感觉、生殖方面的联想，以及处于接受方的期待，可能让人感到自己被放进不想要的女性角色。性别过渡带来的性欲或反应变化可能令人肯定、陌生，或同时带来两种感受。",
  ...
  "attraction-to-women-and-the-imposed-male-role": localizedExperience(
    ...
    [
      ["吸引本身是真实的", "本人可能真诚地感到吸引，同时与附加在这份吸引上的性别含义产生冲突。"],
      ["被他人分配角色", "他人可能依据出生指派性别，把本人当作男人、女人、主动追求者、接受方、男朋友或女朋友。"],
      ["性取向标签把人放错位置", "异性恋、同性恋、女同性恋或双性恋等标签可能依据出生指派性别套用，使本人被放进不准确的角色。"],
      ["合适的理解方式带来放松", "按照自身性别和关系角色理解吸引，可以减轻羞耻感，也让亲密关系更容易接受。"],
    ],
    [
      "对女性的吸引被理解为男性异性恋欲望或男性凝视时，可能引发羞耻。以女性、萨菲或酷儿角色理解同一份吸引，可能更贴合本人。",
      "对男性的吸引被理解为女性异性恋欲望或女性化的接受方角色时，可能令人痛苦。以男性、男同性恋、双性恋或酷儿角色理解这份吸引，可能更贴合本人。",
  ...
  "masturbation-that-affirms-a-feminine-self": localizedExperience(
    ...
    [
      ["性媒体与视角", "本人可能会代入色情内容中身体、视角或角色符合自身性别的人，并把那段体验想象成自己的体验。"],
      ["幻想中的自我定位", "幻想可能在本人理解舒适感的原因以前，就已经把自己放进符合自身性别的身体、角色或视角。"],
      ["自慰与身体", "语言、触摸方式、姿势、玩具或理解身体部位的方式，可能让独处时的性体验更贴合身体和自我。"],
      ["与伴侣的性行为", "伴侣以认可本人性别的方式表达欲望、称呼、触摸或安排体位时，亲密行为可能更舒适、更投入，也更容易带来愉悦。"],
      ["行为与性角色", "插入、接受、主动发起等行为可能令人肯定、感觉中性或引起痛苦，具体取决于这些行为对本人强调的身体部位和性别角色。"],
      ["个体差异", "任何性行为都可以由任何性别的人选择。这里关注的是某种视角、角色或行为对你所具有的性别意义。"],
    ],
    [
      "女性化或女性的身体、视角、称呼和角色，可能让性体验更贴合身体，并带来性别肯定。",
      "男性化或男性的身体、视角、称呼和角色，可能让性体验更贴合身体，并带来性别肯定。",
      "二元性脚本不合适时，中性、混合、流动或自行定义的语言与角色可能带来性别肯定。",
    ],
  ),
};
