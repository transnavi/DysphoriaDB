...
const experiences = {
  ...
  "masturbation-that-affirms-a-feminine-self": claim(
    "偏爱能够肯定女性自我感受的性体验",
    "如果你是跨女性者，当色情内容、幻想、自慰或与伴侣的性行为让你置身于女性或女性化的视角时，你可能会觉得更加自在。强调你不希望关注的身体部位，或把你置于不想承担的性别角色中的性行为，包括插入行为，可能带来疏离感或性别焦虑。",
    [
      ["性媒体与视角", "你可能会代入色情内容中的女性，跟随她们的视角，或想象自己拥有她们的身体或角色。"],
      ["幻想中的自我定位", "你的幻想可能会把你置于女性化的身体、角色或视角中，甚至早于你理解这种感觉为何舒适。"],
      ["自慰与身体", "语言、触摸方式、姿势、玩具或理解身体部位的方式，可能让独处时的性体验更有女性感，也更贴合自己的身体。"],
      ["与伴侣的性行为", "当伴侣把你当作女性来渴望、称呼、触摸或安排体位时，亲密行为可能会让你更自在、更投入或更容易感到愉悦。"],
      ["插入与性角色", "当插入伴侣、被插入或任何插入行为突出了你不希望关注的身体部位或性别角色时，你可能会感到不适、疏离或性别焦虑。"],
